export const dark = {
  colors: {
    ...
    // 
    cardBg:'$contrast0',
    cardShadow:'rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px',
    cardBorder:'none',
    // panel

    panel:'black',
    panelShadow:'rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px',
